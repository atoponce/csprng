...
::
    ...
    rngtest: input channel speed: (min=996.340; avg=4414.318; max=19531250.000)Kibits/s
...
::
    ...
    rngtest: FIPS 140-2(2001-10-10) Continuous run: 0
    rngtest: input channel speed: (min=210482.004; avg=1247765.298; max=0.000)bits/s
